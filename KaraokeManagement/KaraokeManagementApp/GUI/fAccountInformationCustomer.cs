...
namespace GUI
{
    public partial class fAccountInformationCustomer : Form
    {
        private DTO_Customer customer;
        private BUS_AccountInformation processAccountInformation;
        public fAccountInformationCustomer()
        {
            InitializeComponent();
            loadData();
        }
        ...
        private void loadData()
        {
            ...
            customer = processAccountInformation.getCustomerInformation();
        ...
        private void btnConfirmEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                if (processAccountInformation.updateCustomerInformation(new DTO_Customer(name.Text, phone.Text, customer.CustomerUsername), 
                                                                        new DTO_Account(customer.CustomerUsername, password.Text, fLogin.Instance.account.AccountRole)))
                {
