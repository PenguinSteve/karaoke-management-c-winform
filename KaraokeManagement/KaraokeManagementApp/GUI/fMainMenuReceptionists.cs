...
namespace GUI
{
    public partial class fMainMenuReceptionists : Form
    {

        public fMainMenuReceptionists()
        {
            InitializeComponent();
        ...
        {
            openChildForm(new fBooking(), sender);
        }

        private void btnAdvanceBooking_Click(object sender, EventArgs e)
        {
            openChildForm(new fAdvanceBookingStaff(), sender);
        }
