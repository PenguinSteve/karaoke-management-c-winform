...
namespace GUI
{
    public partial class fAdvanceBookingStaff : Form
    {
        ...
        {
            processAdvanceBooking = new BUS_AdvanceBooking();
            dataGridViewBookingDetail.DataSource = processAdvanceBooking.SpecificDataBookingDetail(roomID, timeCompare);
        ...
        private void btnBooking_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    processAdvanceBooking = new BUS_AdvanceBooking();
                    if (processAdvanceBooking.bookRoom(bookID.Text, roomID.Text, timeStart.Value, phone.Text, ""))
                    {
